...
"""
__RCSID__ = "720a4ff (2013-11-11 23:31:04 +0100) Andrei Tsaregorodtsev <atsareg@in2p3.fr>"
...
if __name__ == "__main__":
  ...
  for prog in finalPackages:
    ...
    # for openssl
    if prog == "clientLibReqs":
      os.system("gsed -i 's/1\.0\.1g/1\.0\.1p/g' %s" % makePath)
    if prog == "pyGSI":
      os.system("head -n3 %s > /tmp/pygsimake" % makePath)

      os.system("/bin/echo '# start here to modify a config file _sysconfigdata.py.' >> /tmp/pygsimake")
      os.system("/bin/echo -n \"os.system(\" >> /tmp/pygsimake")
      os.system("/bin/echo -n '\"' >> /tmp/pygsimake")
      os.system("/bin/echo -n 'cp /Users/iwai/work/dirac/Darwin_x86_64_10.11/lib/python2.7/_sysconfigdata.py /Users/iwai/work/dirac/Darwin_x86_64_10.11/lib/python2.7/_sysconfigdata.py.orig' >> /tmp/pygsimake")
      os.system("/bin/echo '\")' >> /tmp/pygsimake")

      os.system("/bin/echo -n \"os.system(\" >> /tmp/pygsimake")
      os.system("/bin/echo -n '\"' >> /tmp/pygsimake")
      os.system("/bin/echo -n \"gsed -i \" >> /tmp/pygsimake")
      os.system("/bin/echo -n '\\\"s|-bundle_loader python\.exe|-bundle_loader /Users/iwai/work/dirac/Darwin_x86_64_10\.11/bin/python2\.7|g\\\"' >> /tmp/pygsimake")
      os.system("/bin/echo ' /Users/iwai/work/dirac/Darwin_x86_64_10.11/lib/python2.7/_sysconfigdata.py\")' >> /tmp/pygsimake")
      os.system("/bin/echo '# end here to modify a config file _sysconfigdata.py.' >> /tmp/pygsimake")
      os.system("tail -n +4 %s >> /tmp/pygsimake" % makePath)
      makePath_bak = makePath + '.bak'
      os.system("mv %s %s" % (makePath, makePath_bak))
      os.system("mv /tmp/pygsimake %s" % makePath)

    # for pyGSI
    #os.system()
    #os.system("gsed 's|^\(.*LDSHARED.*\)\(python\.exe\)\(.*\)$|\1/Users/iwai/work/dirac/Darwin_x86_64_10.11/bin/python2.7\3|g' /Users/iwai/work/dirac/Darwin_x86_64_10.11/lib/python2.7/_sysconfigdata.py")
  ...
  print "Fixing absolute links"
  print "DEBUG before fixAbsoluteLinks"
  fixAbsoluteLinks( compDest )
  print "DEBUG after fixAbsoluteLinks"
